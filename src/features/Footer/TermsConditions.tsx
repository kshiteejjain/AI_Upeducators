    ...
    return (
        <><Header />
            <div className="content container">
                ...
                <p>Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern upEducators AI’ relationship with you in relation to this website. </p>
                <p>The term ‘upEducators AI’ or ‘us’ or ‘we’ refers to the owner of the website whose registered/operational office is C- 501, Park Ivory, Park Street, Wakad, Pune, Maharashtra 411057. The term ‘you’ refers to the user or viewer of our website. </p>
                ...
                <p>The use of this website is subject to the following terms of use: <br />
                    <ul>
                        ...
                        <li>You may not create a link to this website from another website or document without upEducators AI prior written consent.</li>
                ...
                <p>Contact details: <br />
                    <ul>
                        <li><a href="mailto:info@upeducators.com">info@upeducators.com</a></li>
                        <li><a href="tel:+919819860060">+919819860060</a></li>
                    </ul>
                </p>
