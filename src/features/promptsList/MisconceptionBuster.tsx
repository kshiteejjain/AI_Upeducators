...
const MisconceptionBuster = () => {
    ...
    const promptMessage = `Generate 3 common misconceptions for ${formData.gradeLevel} students on the topic ${formData.topic}. Also include effective strategies for addressing each misconception.`
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-group'>
                    ...
                    <input
                        ...
                        placeholder="e.g., Photosynthesis, Pythagorean Theorem, American Revolution"
                    />
                </div>
...
export default MisconceptionBuster;