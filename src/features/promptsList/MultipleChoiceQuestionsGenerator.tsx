...
const MultipleChoiceQuestionsGenerator = () => {
  ...
  const sendPrompt = async (event: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      const promptMessage = `Generate  ${formData.numberOfQuestions} Multiple Choice Questions for ${formData.gradeLevel} on ${formData.topic} for ${formData.board} board with ${formData.DifficultyLevel} difficulty level. Also, provide the correct options for each question.`
  ...
  return (
    <div className="generator-section">
      ...
      <h2>Multiple Choice Questions Generator</h2>
      <h3>Create a multiple choice assessment on any topic, grade, diagnostic assessment, and any other kind you can imagine.</h3>
...
export default MultipleChoiceQuestionsGenerator;