...
const FacebookAdsTargeting = () => {
    ...
    const promptMessage = `I want to start a facebook ads campaign to promote ${formData.courseName} & the target audience is ${formData.audience}. Country is ${formData.country}. Please give detailed targeting available in facebook.
            Don't give me ideas, give me the actual targeting available in facebook ads`;
        ...
        <div className="generator-section">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-group'>
                    ...
                    <select required className='form-control' name="country" onChange={handleInputChange} value={formData.country}>
